...
const cidadeSchema = z.object({
  page: z.number().min(1, "A página deve ser no mínimo 1.").optional(),
  limit: z.number().min(1, "O limite deve ser no mínimo 1.").max(100, "O limite deve ser no máximo 100.").optional(),
